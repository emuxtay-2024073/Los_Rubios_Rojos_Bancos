...
export const AuthPage = () => {
  ...
  return (
    <div className='min-h-screen flex items-center justify-center auth-background px-4 py-12'>
      <div className='auth-card relative w-full max-w-2xl overflow-hidden p-6 md:p-10'>
        ...
        <div className='relative'>
          ...
          <div className='text-center mb-10'>
            <h1 className='text-3xl md:text-4xl font-semibold text-[var(--text-primary)] mb-3 leading-tight'>
              {view === 'forgot'
            ...
            <p className='mx-auto max-w-2xl text-sm text-[var(--text-secondary)]/90 leading-relaxed'>
              {view === 'forgot'
