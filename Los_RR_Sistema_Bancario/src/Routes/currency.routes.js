 ...
 */
router.post('/rates', validateJWT, requireRole('ADMIN', 'SUPER_ADMIN'), addExchangeRate);
 ...
 */
router.delete('/rates/:rateId', validateJWT, requireRole('ADMIN', 'SUPER_ADMIN'), deactivateExchangeRate);
